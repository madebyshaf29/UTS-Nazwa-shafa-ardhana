...
<head>
    ...
    <title>Lupa Password - Dinas Perikanan</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6">
            <div class="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl">
                ...
                <p class="text-sm text-gray-500 mb-8">Masukkan Email yang terdaftar untuk mengatur ulang Password</p>
                ...
                <form action="{{ route('password.email') }}" method="POST">
                    ...
                    <div class="mb-6">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Masukan Email Anda</label>
                        <div class="relative">
